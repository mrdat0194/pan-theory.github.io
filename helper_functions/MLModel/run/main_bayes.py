...
def run(train_link, test_link, result_link, aug_link_1, aug_link_2, save_result=0):
    ...
    X_final, Y_final = data_helper.imbalance_solve(X, Y, X_aug_1, Y_aug_1, X_aug_2, Y_aug_2, -1, rm_thres=0.5)
...
if __name__ == "__main__":
    ...
    result = os.path.join(DATA_DIR, "MLResult","bayes","result_13_0.5_v1.csv")
